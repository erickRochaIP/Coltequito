...
void corredor_iniciar(){
    ...
    // PORTARIA
    strcpy(corredores[0].descricao, "\n A portaria tem uma pequena janelinha a direita(0) que e xxxxxxxxxxxxxxxxxx, e aqui que o porteiro fica e e onde voce pode requisitar chaves para diferentes salas. mais a frente o corredor se divide em tres, pra direita(1), pra esquerda(3) e uma escada pra cima(2)");
